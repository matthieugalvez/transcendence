    ...
    try {
      ...
      limited3Users.forEach(async (user) => {
        ...
        if (onSelect) {
          ...
          selectBtn.className =
            "px-3 py-1 bg-green-600 text-white rounded hover:bg-green-700 transition-colors text-sm";
          ...
          viewBtn.className =
            "px-3 py-1 bg-purple-600 text-white rounded hover:bg-purple-700 transition-colors text-sm";
          ...
          try {
            ...
            if (statusResult.status === "none") {
              ...
              addBtn.className =
                "px-3 py-1 bg-blue-600 text-white rounded hover:bg-blue-700 transition-colors text-sm";
              ...
              friendsBtn.className =
                "px-3 py-1 bg-green-600 text-white rounded cursor-not-allowed text-sm";
    ...
    try {
      ...
      if (result.success) {
        ...
        CommonComponent.showMessage(
          `${language_obj["Sent_to"]} ${user.displayName}!`,
          "success",
        );
