...
export class SettingsRender {
  ...
  static renderMainContent(userName: string, avatarUrl: string): void {
    ...
    const Enable2FAButton = CommonComponent.createStylizedButton(
      `${language_obj["Enable_2FA"]}`,
      "blue",
    );
    ...
    const Disable2FA = CommonComponent.createStylizedButton(
      `${language_obj["Onboardingpage_disable2FA"]}`,
      "red",
    );
    ...
    // Logout button
    const logoutButton = CommonComponent.createStylizedButton(
      `${language_obj["Onboardingpage_logout_button"]}`,
      "red",
    );
    ...
    const saveButton = CommonComponent.createStylizedButton(
      `${language_obj["Save"]}`,
      "purple",
    );
    ...
    const userNameLabel = CommonComponent.createLabel(
      `${language_obj["Change_displayname"]}`,
    );
    const userNameInput = CommonComponent.createInput(
      "text",
    ...
    const passwordLabel = CommonComponent.createLabel(
      `${language_obj["Change_password"]}`,
    );
    const passwordInput = CommonComponent.createInput(
      "password",
      `${language_obj["Enter_password"]}`,
    );
  ...
  private static createAvatarSection(currentAvatarUrl: string): HTMLDivElement {
    ...
    // Avatar label
    const avatarLabel = CommonComponent.createLabel(
      `${language_obj["Profile_avatar"]}`,
    );
    ...
    currentAvatar.onerror = (e) => {
      ...
      if (currentAvatar.src.includes("default")) {
    ...
    const uploadButton = CommonComponent.createStylizedButton(
      `${language_obj["Change_avatar"]}`,
      "blue",
    );
